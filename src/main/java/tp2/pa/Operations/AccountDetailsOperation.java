// tp2.pa.operations/AccountDetailsOperation.java
...
public class AccountDetailsOperation implements BankOperation {
    @Override
    public String getName() {
        return "Ver detalles de cuenta";
    }
    ...
    public void execute(Scanner scanner, User currentUser, AccountController account, AuthController auth, TransactionController transaction) throws Exception {
        String details = account.accountDetails(currentUser);
